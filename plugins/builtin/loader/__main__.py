...
from Ubot.versions import get_version

CHANNEL = Ubot.getCLogger(__name__)


@Ubot.on_cmd("core", about={
...
@Ubot.on_cmd("addrepo", about={
    ...
    'examples': [
        "{tr}addrepo https://github.com/UbotTeam/Ubot-Plugins",
        "{tr}addrepo -b=master https://github.com/UbotTeam/Ubot-Plugins",
        "{tr}addrepo -b=master -p=1 https://github.com/UbotTeam/Ubot-Plugins"]
}, del_pre=True, allow_channels=False)
...
@Ubot.on_cmd("addconsts", about={
    ...
    'examples': [
        ...
        "{tr}addconsts -type=include Ubotteam.Ubot-plugins/executor",
        "{tr}addconsts -type=exclude Ubotteam.Ubot-plugins/fun/",
        "{tr}addconsts -type=in executor help fun/ Ubotteam.Ubot-plugins/video_call"]
}, del_pre=True, allow_channels=False)
...
@Ubot.on_cmd("rmconsts", about={
    ...
    'examples': [
        ...
        "{tr}rmconsts fun/",
        "{tr}rmconsts executor help fun/ Ubotteam.Ubot-plugins/video_call"]
}, del_pre=True, allow_channels=False)
...
@Ubot.on_cmd("update", about={
    'header': "Check Updates or Update Ubot",
