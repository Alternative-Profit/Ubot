...
from Ubot.utils import SafeDict, get_file_id_of_media, parse_buttons
...
class ChannelLogger:
    """ Channel logger for Ubot """
    def __init__(self, client: Union['_client.Ubot', '_client.UbotBot'], name: str) -> None:
