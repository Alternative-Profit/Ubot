...
class Message(RawMessage):
    """ Modded Message Class For Ubot """
    def __init__(self,
                 client: Union['_client.Ubot', '_client.UbotBot'],
    ...
    @classmethod
    def parse(cls, client: Union['_client.Ubot', '_client.UbotBot'],
    ...
    @property
    def client(self) -> Union['_client.Ubot', '_client.UbotBot']:
        """ returns client """
        return self._client
    ...
    async def err(self,
        ...
        Returns:
            On success,
            If Client of message is Ubot:
                the sent :obj:`Message` or True is returned.
            if Client of message is UbotBot:
