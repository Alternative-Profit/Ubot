...
class Filter:
    ...
    @classmethod
    def parse(cls, filters: RawFilter, **kwargs: Union['_client.Ubot', int, bool]) -> 'Filter':
        """ parse filter """
    ...
    def _parse(allow_private: bool,
               ...
               allow_groups: bool,
               allow_channels: bool,
               **kwargs: Union[RawFilter, '_client.Ubot', int, bool]
               ) -> Dict[str, Union[RawFilter, '_client.Ubot', int, bool]]:
